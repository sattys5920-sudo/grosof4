...
export const HALL_EVENTS: HallEvent[] = [
  ...
  },
  {
    ...
    finalClue:
      '괴이에 관한 낡은 책 한 페이지....... "괴이를 완전히 끊어내기 위해서는, 저주가 시작된 뒤로 정확히 10 년을 기다려야 한다. 그 전에는 무엇을 해도 소용이 없다."라고 적혀 있다.',
  },
  {
    id: 'he04',
    roomName: '음악실',
  ...
  },
  {
    ...
    finalClue:
      '2018 년 7 월, 동아리 단체 사진을 찾았다....... 열한 명이 함께 찍혀 있고, 아래에는 민기, 성준, 경태, 소희, 민주, 윤호, 성혜, 기찬, 서영, 병호, {{2018}}, "영원하자!"라는 문구가 적혀 있다.',
  },
  {
    id: 'he06',
    roomName: '경비실',
  ...
  },
  {
    ...
    finalClue:
      '같은 책의 다른 페이지를 찾았다....... "이곳에서 벗어나려면, 이 공간에 깃든 괴이의 정체를 낱낱이 조사해 완전히 타파해야 한다. 그것만이 유일한 길이다."라고 적혀 있다.',
  },
  {
    id: 'he09',
    roomName: '과학실',
    ...
    finalClue:
      '2018 년 8 월, 같은 동아리 단체 사진을 찾았다....... 그런데 이번엔 열 명뿐이다. 민기, 성준, 경태, 소희, 민주, 윤호, 성혜, 기찬, 서영, 병호, 이렇게 열 명만 찍혀 있고, 아래에는 "오늘도 무섭게!"라고 적혀 있다.',
  },
  {
    id: 'he10',
    roomName: '무용실',
