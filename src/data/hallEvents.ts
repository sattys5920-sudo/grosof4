...
export const HALL_EVENTS: HallEvent[] = [
  {
    ...
    logs: [
      ...
      {
        text: '의자가 다시 한 번 혼자 덜그럭거린다....... 수상하다. 아무도 손대지 않았는데 등받이가 조금씩 이쪽으로 돌아오고 있다.',
        choices: CHOICES(
      ...
      {
        text: '넘어가던 페이지가 어느 한 곳에서 멈춘다....... 11 번 자리 칸에, 이름이 있어야 할 자리가 비어 있다. 그 위에 손톱으로 긁은 듯한 자국이 남아 있다.',
      },
      {
    ...
    objects: [
      {
        ...
        minigameRule: '서랍이 여러 칸이다....... 승부는 그것과의 홀짝으로 정한다. 한 명만 도전할 수 있다.',
        hpDamage: 10,
        minigameWinCoins: 3,
      },
      ...
      },
      {
        ...
        label: '낡은 커피포트',
        kind: 'minigame',
        minigameKind: 'numberbaseball',
        minigameRule:
          '커피포트 안쪽에 숫자 다이얼이 달려 있다....... 서로 다른 숫자 세 개를 맞혀야 열린다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 5,
      },
    ...
    finalClue:
      '1. 아침 조회는 오전 8 시 30 분에 시작합니다. 늦게 도착한 학생은 조용히 자리에 앉아 주십시오. 급식실은 2 층에 있습니다.\n2. 2 층에 없을 경우 찾으러 다니지 마십시오. 도서관은 매주 월요일 휴관입니다. 월요일에 안에서 책장을 넘기는 소리가 들려도 들어가지 마십시오.\n3. 교복 셔츠는 흰색이어야 합니다. 다른 색의 셔츠를 입은 학생과는 대화하지 마십시오.\n4. 동아리실은 3 층 복도 끝에 있습니다. 복도 끝에서 누군가 부르더라도 바로 들어가지 마십시오.\n5. 야간 자율학습은 오후 10 시에 종료됩니다. 10 시 이후 자신의 이름을 부르는 소리가 들려도 대답하지 마십시오.\n6. 체육복은 하복과 동복으로 나뉩니다. 둘 중 어느 것에도 해당하지 않는 체육복은 입지 마십시오.\n7. 매점은 쉬는 시간에만 운영됩니다. 쉬는 시간이 아닌데 문이 열려 있다면 이용하지 마십시오.\n8. 교문은 오후 9 시에 닫힙니다. 그 이후 교문 밖에 있는 사람에게 말을 걸지 마십시오.\n9. 신입 부원은 매년 한 명씩 받습니다. 자신보다 먼저 들어온 신입 부원이 있다면 이름을 묻지 마십시오.\n10. 사물함은 학년이 바뀌면 새로 배정됩니다. 이전 사물함에 남아 있는 물건은 가져가지 마십시오.\n11. 괴담동아리에는 11 번째 학생이 없습니다.\n12. 졸업 앨범은 2 월에 배부됩니다. 자신의 사진이 없는 앨범을 받았다면 펼쳐보지 마십시오. 운동장 조회는 매주 월요일에 실시합니다. 줄에 모르는 학생이 있어도 인원수를 세지 마십시오.\n13. 학교 축제는 10 월에 열립니다. 축제가 끝난 뒤 들리는 음악에는 따라가지 마십시오.',
  },
  {
    id: 'he03',
    roomName: '미술실',
    ...
    objects: [
      {
        ...
        kind: 'minigame',
        minigameKind: 'poker',
        minigameRule: '석고상 중 하나를 골라 옮겨 본다....... 승부는 그것과의 카드 대결로 정한다. 한 명만 도전할 수 있다.',
        hpDamage: 13,
        minigameWinCoins: 3,
      },
      { id: 'he03-o2', label: '빈 이젤', kind: 'puzzle', puzzleId: 'hp07' },
      {
        ...
        kind: 'minigame',
        minigameKind: 'robo77',
        minigameRule: '캐비닛 서랍 중 하나를 골라 열어 본다....... 승부는 그것과의 로보 77 승부로 정한다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
      {
    ...
    finalClue:
      '괴이에 관한 낡은 책 한 페이지....... "괴이를 완전히 끊어내기 위해서는, 저주가 시작된 뒤로 정확히 열 명을 기다려야 한다. 그 전에는 무엇을 해도 소용이 없다."라고 적혀 있다.',
  },
  {
    id: 'he04',
    roomName: '음악실',
    ...
    objects: [
      {
        ...
        kind: 'minigame',
        minigameKind: 'numberbaseball',
        minigameRule: '건반 뚜껑 안쪽에 숫자 다이얼이 숨겨져 있다....... 서로 다른 숫자 세 개를 맞혀야 열린다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 5,
      },
      {
        ...
        kind: 'minigame',
        minigameKind: 'poker',
        minigameRule: '악보 뭉치 중 하나를 골라 꺼내 본다....... 승부는 그것과의 카드 대결로 정한다. 한 명만 도전할 수 있다.',
        hpDamage: 12,
        minigameWinCoins: 3,
      },
    ...
    finalClue:
      '누렇게 바랜 신문 조각을 찾았다....... "인근 폐가 탐방하려던 여고생, 귀갓길 뺑소니 사고로 실종" — 흉가로 소문난 폐건물을 탐방하러 늦은 시각 홀로 향하던 유 모(당시 17) 양이 귀가하던 중 뺑소니 사고를 당했다는 기사다.',
  },
  {
    id: 'he08',
    roomName: '창고',
    ...
    objects: [
      {
        ...
        label: '낡은 책상 더미',
        kind: 'minigame',
        minigameKind: 'davinci',
        minigameRule: '책상 서랍 안에 숫자패 네 개가 순서대로 놓여 있다....... 왼쪽부터 오름차순이라는 것만 알 수 있다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 5,
      },
      {
        ...
        kind: 'minigame',
        minigameKind: 'oddeven',
        minigameRule: '도구함 안 물건 하나를 골라 꺼내 본다....... 승부는 그것과의 홀짝으로 정한다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
    ...
    finalClue:
      '같은 책의 다른 페이지를 찾았다....... "이곳에서 벗어나려면, 이 공간에 깃든 괴이의 정체를 낱낱이 조사해 완전히 타파해야 한다. 그것만이 유일한 길이다. 그리고 그 학생만이 유일한 빛이다."라고 적혀 있다.',
  },
  {
    id: 'he05',
    roomName: '운동장',
    ...
    objects: [
      {
        ...
        minigameKind: 'davinci',
        minigameRule:
          '벤치 아래 숨겨진 숫자패 네 개가 순서대로 놓여 있다....... 왼쪽부터 오름차순이라는 것만 알 수 있다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 5,
      },
      { id: 'he05-o2', label: '텅 빈 골대의 그물', kind: 'puzzle', puzzleId: 'hp13' },
      {
        ...
        kind: 'minigame',
        minigameKind: 'oddeven',
        minigameRule: '마이크 스위치를 눌러 본다....... 승부는 그것과의 홀짝으로 정한다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
      {
    ...
    finalClue:
      '동아리 단체 사진을 찾았다....... 열한 명이 함께 찍혀 있고, 아래에는 민기, 성준, 경태, 소희, 민주, 윤호, 성혜, 기찬, 서영, 병호, {{2018}}, "영원하자! 2018. 07."라는 문구가 적혀 있다.',
  },
  {
    id: 'he02',
    roomName: '체육실',
    ...
    logs: [
      ...
      {
        text: '구석에 쌓인 매트 더미가 다시 한 번 크게 부풀어 오른다....... 숨 쉬듯 부풀었다 가라앉는다. 그 틈에서 옅은 신음소리가 새어 나오는 것 같다.',
        choices: CHOICES(
    ...
    objects: [
      {
        ...
        kind: 'minigame',
        minigameKind: 'robo77',
        minigameRule: '바구니 속 공 하나를 골라 꺼내 본다....... 승부는 그것과의 로보 77 승부로 정한다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
      {
        ...
        kind: 'minigame',
        minigameKind: 'oddeven',
        minigameRule: '매트 더미 중 하나를 골라 잡아당겨 본다....... 승부는 그것과의 홀짝으로 정한다. 한 명만 도전할 수 있다.',
        hpDamage: 12,
        minigameWinCoins: 3,
      },
  ...
  },
  {
    ...
    objects: [
      {
        ...
        kind: 'minigame',
        minigameKind: 'numberbaseball',
        minigameRule: '트레이 밑에 숫자 다이얼이 붙어 있다....... 서로 다른 숫자 세 개를 맞혀야 열린다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 5,
      },
      {
        ...
        kind: 'minigame',
        minigameKind: 'poker',
        minigameRule: '냉장고 칸 하나를 골라 열어 본다....... 승부는 그것과의 카드 대결로 정한다. 한 명만 도전할 수 있다.',
        staminaDamage: 12,
        minigameWinCoins: 3,
      },
    ...
    finalClue:
      '2026 년에 가입한 부원의 자기소개 게시글을 찾았다....... 옆에 작은 녹음 파일이 첨부되어 있다. 재생하자 {{2026}}의 목소리가 흘러나온다. "안녕하세요! 11 번째 부원으로 들어오게 되어 정말 기뻐요. 함께하게 돼서 너무 즐겁고 설레요. 같이 무서운 일들 많이 경험할 수 있으면 좋겠어요."',
  },
  {
    id: 'he06',
    roomName: '경비실',
    ...
    objects: [
      { id: 'he06-o1', label: 'CCTV 모니터', kind: 'puzzle', puzzleId: 'hp16' },
      {
        ...
        kind: 'minigame',
        minigameKind: 'davinci',
        minigameRule: '기록부 페이지 사이에 숫자패 네 개가 순서대로 끼워져 있다....... 왼쪽부터 오름차순이라는 것만 알 수 있다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 5,
      },
      {
        ...
        kind: 'minigame',
        minigameKind: 'robo77',
        minigameRule: '열쇠 하나를 골라 꺼내 본다....... 승부는 그것과의 로보 77 승부로 정한다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
      {
    ...
    finalClue:
      '언니는억울해언니는억울해언니는억울해언니는억울해언니는억울해언니는억울해언니는억울해언니는억울해친구라고했잖아친구라고했잖아친구라고했잖아친구라고했잖아친구라고했잖아친구라고했잖아친구라고했잖아친구라고했잖아친구라고했잖아친구라고했잖아친구라고했잖아친구라고했잖아친구라고했잖아쟤네가친구라고했어그런데너는아니었나?',
    finalClueEmphasis: true,
  },
  {
    id: 'he09',
    roomName: '과학실',
    ...
    objects: [
      {
        ...
        kind: 'minigame',
        minigameKind: 'numberbaseball',
        minigameRule: '진열장 자물쇠에 숫자 다이얼이 달려 있다....... 서로 다른 숫자 세 개를 맞혀야 열린다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 5,
      },
      {
        ...
        kind: 'minigame',
        minigameKind: 'robo77',
        minigameRule: '노트 페이지 하나를 골라 넘겨 본다....... 승부는 그것과의 로보 77 승부로 정한다. 한 명만 도전할 수 있다.',
        hpDamage: 11,
        minigameWinCoins: 3,
      },
    ...
    finalClue:
      '같은 동아리 단체 사진을 찾았다....... 그런데 이번엔 열 명뿐이다. 민기, 성준, 경태, 소희, 민주, 윤호, 성혜, 기찬, 서영, 병호, 이렇게 열 명만 찍혀 있고, 아래에는 "오늘도 무섭게! 2018. 08."라고 적혀 있다.',
  },
  {
    id: 'he10',
    roomName: '무용실',
    ...
    objects: [
      { id: 'he10-o1', label: '전면 거울벽', kind: 'puzzle', puzzleId: 'hp28' },
      {
        ...
        kind: 'minigame',
        minigameKind: 'davinci',
        minigameRule: '발레바 받침대에 숫자패 네 개가 순서대로 박혀 있다....... 왼쪽부터 오름차순이라는 것만 알 수 있다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 5,
      },
      {
        ...
        kind: 'minigame',
        minigameKind: 'poker',
        minigameRule: '스피커 버튼 하나를 골라 눌러 본다....... 승부는 그것과의 카드 대결로 정한다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
      {
