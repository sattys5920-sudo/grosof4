import type { HallEvent } from './types'
...
export const HALL_EVENTS: HallEvent[] = [
  {
    ...
    logs: [
      '문을 열자 형광등 하나만 깜빡이고 있다....... 책상들은 각자의 자리에 그대로지만, 의자 하나만 안쪽을 향해 돌아가 있다.',
      '가운데 교탁 위, 출석부가 펼쳐진 채 놓여 있다....... 페이지가 저절로 한 장씩 넘어간다.',
      '넘어가던 페이지가 어느 한 곳에서 멈춘다....... 11번 자리 칸에, 이름이 있어야 할 자리가 비어 있다.',
      '어디선가 작게 속삭이는 소리가 들린다. "……열, 하나, 셋……" 숫자를 세는 것 같다. 세는 순서가 이상하다.',
    ],
    objects: [
      {
        id: 'he01-o1',
        label: '국어 선생님의 서랍장',
        kind: 'minigame',
        minigameRule: '서랍이 여러 칸이다....... 하나를 골라 당겨 본다. 안에 무엇이 들었을지는 열어 봐야 안다.',
        hpDamage: 10,
        minigameWinCoins: 3,
      },
      ...
      },
      {
        ...
        label: '낡은 커피포트',
        kind: 'minigame',
        minigameRule: '커피포트 스위치를 누를지 말지....... 전원이 붙어 있는지 확신할 수 없다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
  ...
  },
  {
    ...
    logs: [
      '창고 문을 열자 퀴퀴한 땀 냄새와 함께 서늘한 바람이 훅 끼친다....... 스위치를 켜도 조명 절반은 들어오지 않는다.',
      '구석에 쌓인 매트 더미가 아주 조금씩, 숨 쉬듯 부풀었다 가라앉는다.',
      '벽에 걸린 트로피들이 유리 진열장 안에서 서로 부딪히며 잘그락 소리를 낸다....... 바람 한 점 없는데도.',
      '네트 한가운데, 흰 손가락 같은 것이 비집고 나와 있다가 스르륵 사라진다.',
    ],
    objects: [
      {
        id: 'he02-o1',
        label: '배구공이 담긴 바구니',
        kind: 'minigame',
        minigameRule: '바구니 속 공 하나를 골라 꺼내 본다....... 어느 공에 무엇이 묻어 있을지 모른다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
      {
        ...
        label: '쌓아 올린 매트 더미',
        kind: 'minigame',
        minigameRule: '매트 더미 중 하나를 골라 잡아당겨 본다....... 무너질지 아닐지는 운에 달렸다.',
        hpDamage: 12,
        minigameWinCoins: 3,
      },
  ...
  },
  {
    ...
    logs: [
      '문을 열자 물감 냄새가 유난히 진하게 코를 찌른다....... 이젤 위에는 아무도 그리지 않은 그림 한 점이 놓여 있다.',
      '석고상들이 조금씩 다른 방향을 보고 있다....... 전부 문 쪽을, 정확히는 방금 들어온 사람 쪽을 향해 있다.',
      '캔버스 위 그림 속 인물의 얼굴이 텅 비어 있다....... 자세히 보니 물감이 채 마르지 않았다.',
      '붓 하나가 저절로 굴러 바닥에 떨어진다....... 누군가 방금 내려놓은 것처럼.',
    ],
    objects: [
      {
        id: 'he03-o1',
        label: '석고상 진열대',
        kind: 'minigame',
        minigameRule: '석고상 중 하나를 골라 옮겨 본다....... 무게 중심이 어느 쪽인지는 들어 봐야 안다.',
        hpDamage: 13,
        minigameWinCoins: 3,
      },
      { id: 'he03-o2', label: '빈 이젤', kind: 'puzzle', puzzleId: 'hp07' },
      {
        ...
        label: '물감 캐비닛',
        kind: 'minigame',
        minigameRule: '캐비닛 서랍 중 하나를 골라 열어 본다....... 안에서 무엇이 쏟아질지 모른다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
      {
  ...
  },
  {
    ...
    logs: [
      '문을 열자 피아노 소리가 뚝 끊긴다....... 방금까지 분명 무언가 연주하고 있었다.',
      '보면대 위에 낯선 악보 한 장이 놓여 있다....... 음표 대신 이상한 기호들이 빼곡하다.',
      '타악기 창고 쪽에서 낮은 북소리가 규칙적으로 울린다....... 심장 박동과 비슷한 간격이다.',
      '메트로놈이 저절로 움직이기 시작한다....... 속도가 점점 빨라진다.',
    ],
    objects: [
      {
        id: 'he04-o1',
        label: '그랜드피아노 건반 뚜껑',
        kind: 'minigame',
        minigameRule: '건반을 하나 골라 눌러 본다....... 어느 건반에서 무슨 소리가 날지 모른다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
      {
        ...
        label: '악보 보관함',
        kind: 'minigame',
        minigameRule: '악보 뭉치 중 하나를 골라 꺼내 본다....... 종이 모서리가 어느 쪽에 있을지 모른다.',
        hpDamage: 12,
        minigameWinCoins: 3,
      },
  ...
  },
  {
    ...
    logs: [
      '운동장에 나서자 안개가 발목까지 차오른다....... 트랙 표시선이 평소보다 하나 더 그려져 있는 것 같다.',
      '조회대 위 그림자가 조금씩 움직인다....... 마치 누군가 그 위에서 전교생을 내려다보고 있는 것처럼.',
      '골대 그물이 바람 없이 흔들린다....... 그 안에 무언가 걸려 있는 듯하다.',
      '국기게양줄이 저절로 팽팽해지며 삐걱거리는 소리를 낸다.',
    ],
    objects: [
      {
        id: 'he05-o1',
        label: '스탠드 벤치',
        kind: 'minigame',
        minigameRule: '벤치 자리 하나를 골라 앉아 본다....... 못이 튀어나온 자리가 어디인지 모른다.',
        hpDamage: 10,
        minigameWinCoins: 3,
      },
      { id: 'he05-o2', label: '텅 빈 골대의 그물', kind: 'puzzle', puzzleId: 'hp13' },
      {
        ...
        label: '조회대 마이크',
        kind: 'minigame',
        minigameRule: '마이크 스위치를 눌러 본다....... 전류가 흐르고 있을지는 알 수 없다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
      {
  ...
  },
  {
    ...
    logs: [
      '경비실 문을 열자 모니터 여러 대가 지지직거리며 화면이 깜빡인다.',
      '출입 기록부를 펼치자 오늘 날짜 칸에 낯선 필체로 이름 하나가 적혀 있다....... 아무도 못 보던 이름이다.',
      '무전기에서 잡음 섞인 숫자가 반복해서 흘러나온다....... "열, 하나, 열, 하나……."',
      '모니터 한 대가 꺼졌다 켜지며, 화면 속 그림자가 카메라 쪽으로 한 걸음 다가와 있다.',
    ],
    objects: [
      { id: 'he06-o1', label: 'CCTV 모니터', kind: 'puzzle', puzzleId: 'hp16' },
      {
        ...
        label: '출입 기록부',
        kind: 'minigame',
        minigameRule: '기록부 페이지 하나를 골라 넘겨 본다....... 종이 모서리가 날카로운 곳이 어딘지 모른다.',
        hpDamage: 10,
        minigameWinCoins: 3,
      },
      {
        ...
        label: '열쇠 보관함',
        kind: 'minigame',
        minigameRule: '열쇠 하나를 골라 꺼내 본다....... 어느 열쇠가 녹슬어 있을지 모른다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
      {
  ...
  },
  {
    ...
    logs: [
      '식당 안은 조용하다....... 배식대 위 조명만 홀로 켜져 있다.',
      '테이블 맨 끝, 식판 하나가 김이 나는 채로 놓여 있다....... 방금 누군가 받아 온 것처럼.',
      '냉장고 문이 저절로 살짝 열렸다 닫힌다....... 안에서 서늘한 바람이 새어 나온다.',
      '식판 옆 젓가락이 저절로 미세하게 움직인다....... 마치 누군가 아직 식사 중인 것처럼.',
    ],
    objects: [
      {
        id: 'he07-o1',
        label: '배식대 앞 트레이',
        kind: 'minigame',
        minigameRule: '트레이 하나를 골라 들어 본다....... 어느 트레이가 뜨거울지 모른다.',
        hpDamage: 10,
        minigameWinCoins: 3,
      },
      {
        ...
        label: '대형 냉장고',
        kind: 'minigame',
        minigameRule: '냉장고 칸 하나를 골라 열어 본다....... 어느 칸에서 찬 바람이 세게 나올지 모른다.',
        staminaDamage: 12,
        minigameWinCoins: 3,
      },
  ...
  },
  {
    ...
    logs: [
      '창고 문을 열자 먼지 냄새가 훅 끼친다....... 손전등 불빛이 닿는 곳마다 그림자가 길게 늘어진다.',
      '낡은 책상들이 아무렇게나 쌓여 있다....... 그중 하나에는 낯익은 낙서가 남아 있다.',
      '깨진 거울 조각 하나가 저절로 조금씩 움직여 방향을 바꾼다.',
      '박스 더미 안쪽에서 부스럭거리는 소리가 난다....... 쥐치고는 소리가 너무 크다.',
    ],
    objects: [
      {
        id: 'he08-o1',
        label: '낡은 책상 더미',
        kind: 'minigame',
        minigameRule: '책상 하나를 골라 옮겨 본다....... 다리가 성한 책상이 어느 것인지 모른다.',
        hpDamage: 12,
        minigameWinCoins: 3,
      },
      {
        ...
        label: '청소도구함',
        kind: 'minigame',
        minigameRule: '도구함 안 물건 하나를 골라 꺼내 본다....... 무엇이 손에 잡힐지 모른다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
  ...
  },
  {
    ...
    logs: [
      '과학실 문을 열자 포르말린 냄새가 코를 찌른다....... 형광등이 지지직거리며 불안정하게 깜빡인다.',
      '표본병들이 진열장 안에서 아주 조금씩 흔들린다....... 지진이라기엔 흔들림이 너무 규칙적이다.',
      '실험 노트 한 권이 저절로 펼쳐진다....... 마지막 페이지에 끝맺지 못한 문장이 남아 있다.',
      '분젠버너에 불이 저절로 붙었다 꺼진다....... 아무도 가스 밸브를 돌리지 않았는데.',
    ],
    objects: [
      {
        id: 'he09-o1',
        label: '표본병 진열장',
        kind: 'minigame',
        minigameRule: '표본병 하나를 골라 꺼내 본다....... 어느 병 마개가 헐거운지 모른다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
      {
        ...
        label: '펼쳐진 실험 노트',
        kind: 'minigame',
        minigameRule: '노트 페이지 하나를 골라 넘겨 본다....... 어느 페이지 모서리가 날카로운지 모른다.',
        hpDamage: 11,
        minigameWinCoins: 3,
      },
  ...
  },
  {
    ...
    logs: [
      '무용실 문을 열자 거울벽에 비친 자기 모습이 한 박자 늦게 따라 움직인다.',
      '발레바 앞, 낡은 카세트 플레이어에서 아무도 튼 적 없는 음악이 흘러나온다.',
      '거울 속에 비친 인원을 세어 보니 실제보다 하나가 많다....... 거울 속 그 형체가 이쪽을 보고 살짝 웃는다.',
      '음향 스피커에서 지지직거리는 잡음 사이로 낮은 박자 소리가 섞여 든다....... 발소리 같기도 하다.',
    ],
    objects: [
      { id: 'he10-o1', label: '전면 거울벽', kind: 'puzzle', puzzleId: 'hp28' },
      {
        ...
        label: '발레바',
        kind: 'minigame',
        minigameRule: '바를 붙잡을 위치를 하나 골라 본다....... 어느 구간의 나사가 풀려 있을지 모른다.',
        hpDamage: 13,
        minigameWinCoins: 3,
      },
      {
        ...
        label: '음향 스피커',
        kind: 'minigame',
        minigameRule: '스피커 버튼 하나를 골라 눌러 본다....... 어느 버튼이 과부하 상태인지 모른다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
      {
