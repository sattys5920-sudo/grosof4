    ...
    objects: [
      {
        ...
        kind: 'minigame',
        minigameKind: 'oddeven',
        minigameRule: '건반을 하나 골라 눌러 본다....... 승부는 그것과의 홀짝으로 정한다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
      {
    ...
    objects: [
      {
        ...
        kind: 'minigame',
        minigameKind: 'robo77',
        minigameRule: '책상 하나를 골라 옮겨 본다....... 승부는 그것과의 로보 77 승부로 정한다. 한 명만 도전할 수 있다.',
        hpDamage: 12,
        minigameWinCoins: 3,
      },
      {
    ...
    objects: [
      {
        ...
        kind: 'minigame',
        minigameKind: 'oddeven',
        minigameRule: '트레이 하나를 골라 들어 본다....... 승부는 그것과의 홀짝으로 정한다. 한 명만 도전할 수 있다.',
        hpDamage: 10,
        minigameWinCoins: 3,
      },
      {
  ...
  },
  {
    ...
    objects: [
      { id: 'he06-o1', label: 'CCTV 모니터', kind: 'puzzle', puzzleId: 'hp16' },
      {
        ...
        kind: 'minigame',
        minigameKind: 'poker',
        minigameRule: '기록부 페이지 하나를 골라 넘겨 본다....... 승부는 그것과의 카드 대결로 정한다. 한 명만 도전할 수 있다.',
        hpDamage: 10,
        minigameWinCoins: 3,
      },
      {
    ...
    objects: [
      {
        ...
        kind: 'minigame',
        minigameKind: 'poker',
        minigameRule: '표본병 하나를 골라 꺼내 본다....... 승부는 그것과의 카드 대결로 정한다. 한 명만 도전할 수 있다.',
        staminaDamage: 10,
        minigameWinCoins: 3,
      },
      {
  ...
  },
  {
    ...
    objects: [
      { id: 'he10-o1', label: '전면 거울벽', kind: 'puzzle', puzzleId: 'hp28' },
      {
        ...
        kind: 'minigame',
        minigameKind: 'oddeven',
        minigameRule: '바를 붙잡을 위치를 하나 골라 본다....... 승부는 그것과의 홀짝으로 정한다. 한 명만 도전할 수 있다.',
        hpDamage: 13,
        minigameWinCoins: 3,
      },
      {
