...
export const HALL_EVENTS: HallEvent[] = [
    ...
    objects: [
      {
        ...
        label: '국어 선생님의 서랍장',
        kind: 'hazard',
        hazardText: '서랍을 당기자 안에서 붉은 잉크가 왈칵 쏟아져 손등을 적신다....... 손이 따끔거린다.',
        hpDamage: 10,
      },
      ...
      { id: 'he01-o4', label: '낡은 커피포트', kind: 'item', itemShopId: 'sh-food-1' },
  ...
  },
  {
    ...
    objects: [
      { id: 'he02-o1', label: '배구공이 담긴 바구니', kind: 'item', itemCoins: 2 },
      {
        id: 'he02-o2',
        label: '쌓아 올린 매트 더미',
        kind: 'hazard',
        hazardText: '매트 하나를 잡아당기자 위쪽 더미가 와르르 무너져 내린다....... 어깨를 세게 맞았다.',
        hpDamage: 12,
      },
    ...
    objects: [
      {
        ...
        label: '석고상 진열대',
        kind: 'hazard',
        hazardText: '석고상 하나를 옮기려는 순간 손에서 미끄러져 발등에 떨어진다....... 묵직한 통증이 퍼진다.',
        hpDamage: 13,
      },
      { id: 'he03-o2', label: '빈 이젤', kind: 'puzzle', puzzleId: 'hp07' },
      { id: 'he03-o3', label: '물감 캐비닛', kind: 'item', itemCoins: 2 },
      {
        id: 'he03-o4',
        label: '조소용 점토함',
        kind: 'hazard',
  ...
  },
  {
    ...
    objects: [
      { id: 'he04-o1', label: '그랜드피아노 건반 뚜껑', kind: 'item', itemCoins: 2 },
      {
        id: 'he04-o2',
        label: '악보 보관함',
        kind: 'hazard',
        hazardText: '악보 뭉치를 꺼내자 종이 모서리에 손가락을 깊게 베인다....... 생각보다 피가 많이 난다.',
        hpDamage: 12,
      },
    ...
    objects: [
      {
        ...
        label: '스탠드 벤치',
        kind: 'hazard',
        hazardText: '벤치에 앉으려는 순간 낡은 못이 튀어나와 다리를 긁는다....... 상처가 화끈거린다.',
        hpDamage: 10,
      },
      { id: 'he05-o2', label: '텅 빈 골대의 그물', kind: 'puzzle', puzzleId: 'hp13' },
      { id: 'he05-o3', label: '조회대 마이크', kind: 'item', itemCoins: 2 },
      {
        id: 'he05-o4',
        label: '국기게양대 줄',
        kind: 'hazard',
  ...
  },
  {
    ...
    objects: [
      { id: 'he06-o1', label: 'CCTV 모니터', kind: 'puzzle', puzzleId: 'hp16' },
      {
        ...
        label: '출입 기록부',
        kind: 'hazard',
        hazardText: '기록부를 넘기다 손끝이 종이에 베인다....... 잉크가 상처에 닿자 따끔하게 저려 온다.',
        hpDamage: 10,
      },
      { id: 'he06-o3', label: '열쇠 보관함', kind: 'item', itemCoins: 2 },
      {
        id: 'he06-o4',
        label: '무전기',
        kind: 'hazard',
  ...
  },
  {
    ...
    objects: [
      { id: 'he07-o1', label: '배식대 앞 트레이', kind: 'item', itemShopId: 'sh-food-1' },
      {
        id: 'he07-o2',
        label: '대형 냉장고',
        kind: 'hazard',
        hazardText: '문을 여는 순간 안에서 찬 바람이 훅 끼치며 손이 얼얼하게 저려 온다.',
        staminaDamage: 12,
      },
    ...
    objects: [
      {
        ...
        label: '낡은 책상 더미',
        kind: 'hazard',
        hazardText: '책상 하나를 옮기려다 다리가 무너지며 발등을 찧는다.',
        hpDamage: 12,
      },
      { id: 'he08-o2', label: '청소도구함', kind: 'item', itemCoins: 2 },
  ...
  },
  {
    ...
    objects: [
      { id: 'he09-o1', label: '표본병 진열장', kind: 'item', itemCoins: 2 },
      {
        id: 'he09-o2',
        label: '펼쳐진 실험 노트',
        kind: 'hazard',
        hazardText: '노트를 넘기다 종이 모서리에 손가락을 깊게 베인다.',
        hpDamage: 11,
      },
  ...
  },
  {
    ...
    objects: [
      { id: 'he10-o1', label: '전면 거울벽', kind: 'puzzle', puzzleId: 'hp28' },
      {
        ...
        label: '발레바',
        kind: 'hazard',
        hazardText: '바를 붙잡는 순간 고정 나사가 빠지며 손목이 크게 꺾인다.',
        hpDamage: 13,
      },
      { id: 'he10-o3', label: '음향 스피커', kind: 'item', itemCoins: 2 },
      {
        id: 'he10-o4',
        label: '의상 보관함',
        kind: 'hazard',
