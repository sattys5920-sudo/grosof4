...
export const CREATURES: Creature[] = [
  // 하 (쉬움) — 10 종
  {
    ...
    category: '귀신',
    difficulty: 'easy',
    intro: '그림자 속에서 작은 실루엣 하나가 꿈틀거린다....... 사람처럼 보이지만, 키가 너무 작다.',
    hp: 14,
    atk: 3,
    def: 0,
    coinReward: 10,
  ...
  },
  {
    ...
    category: '귀신',
    difficulty: 'easy',
    intro: '아무도 없는데 사물함 두드리는 소리가 규칙적으로 들려온다....... 쿵, 쿵, 쿵.',
    hp: 16,
    atk: 3,
    def: 0,
    coinReward: 10,
  ...
  },
  {
    ...
    category: '귀신',
    difficulty: 'easy',
    intro: '뒤에서 다가오는 발소리가 들린다....... 돌아보면 아무도 없는데, 발소리는 멈추지 않는다.',
    hp: 18,
    atk: 4,
    def: 0,
    coinReward: 12,
  ...
  },
  {
    ...
    category: '귀신',
    difficulty: 'easy',
    intro: '맨 끝 칸에서 낮은 흐느낌이 새어 나온다....... 문은 안에서 잠겨 있다.',
    hp: 20,
    atk: 4,
    def: 1,
    coinReward: 13,
  ...
  },
  {
    ...
    category: '크리쳐',
    difficulty: 'easy',
    intro: '구석의 마네킹이 방금 전과 다른 자세로 서 있다....... 목이 조금 더 꺾여 있다.',
    hp: 20,
    atk: 4,
    def: 1,
    coinReward: 14,
  ...
  },
  {
    ...
    category: '크리쳐',
    difficulty: 'easy',
    intro: '구석에서 검은 형체가 빠르게 오간다....... 쥐치고는 너무 크다.',
    hp: 16,
    atk: 4,
    def: 0,
    coinReward: 11,
  ...
  },
  {
    ...
    category: '귀신',
    difficulty: 'easy',
    intro: '벽 낙서 속 눈동자 하나가 이쪽을 빤히 보고 있다....... 방금 전엔 없던 낙서다.',
    hp: 22,
    atk: 5,
    def: 1,
    coinReward: 15,
  ...
  },
  {
    ...
    category: '귀신',
    difficulty: 'medium',
    intro: '커튼 뒤에 사람 형태의 흰 그림자가 미동도 없이 서 있다.......',
    hp: 32,
    atk: 6,
    def: 2,
    coinReward: 21,
  ...
  },
  {
    ...
    category: '귀신',
    difficulty: 'medium',
    intro: '비가 오지 않는데도 검은 우산을 든 형체가 젖은 채 서 있다.......',
    hp: 36,
    atk: 8,
    def: 2,
    coinReward: 25,
  ...
  },
  {
    ...
    category: '크리쳐',
    difficulty: 'medium',
    intro: '구석의 인체 모형이 관절 소리를 내며 스스로 고개를 돌린다.......',
    hp: 40,
    atk: 8,
    def: 3,
    coinReward: 27,
  ...
  },
  {
    ...
    category: '귀신',
    difficulty: 'medium',
    intro: '불 꺼진 곳, 아무도 없어야 할 자리에 한 학생이 조용히 문제집을 넘기고 있다.......',
    hp: 38,
    atk: 7,
    def: 2,
    coinReward: 24,
  ...
  },
  {
    ...
    category: '귀신',
    difficulty: 'medium',
    intro: '물탱크 위로 물에 젖은 형체가 천천히 몸을 일으킨다.......',
    hp: 42,
    atk: 9,
    def: 3,
    coinReward: 30,
  ...
  // 상 (어려움) — 10 종
  {
    ...
    category: '귀신',
    difficulty: 'hard',
    intro: '난간 위에 하얀 그림자가 걸터앉아 있다....... 안개 너머로 발밑이 보이지 않는다.',
    hp: 52,
    atk: 10,
    def: 3,
    coinReward: 36,
  ...
  },
  {
    ...
    category: '크리쳐',
    difficulty: 'hard',
    intro: '오래전 멈춘 시계의 초침이 거꾸로 돌기 시작한다....... 그 아래 그림자가 점점 짙어진다.',
    hp: 62,
    atk: 13,
    def: 4,
    coinReward: 45,
  ...
  },
  {
    ...
    category: '귀신',
    difficulty: 'hard',
    intro: '문 앞을 지키고 선 형체가 녹슨 열쇠를 손에 꼭 쥔 채 놓지 않는다.......',
    hp: 68,
    atk: 15,
    def: 5,
    coinReward: 55,
  ...
  // 구관 추가 크리쳐 — 3 종
  {
    ...
    category: '크리쳐',
    difficulty: 'easy',
    intro: '철문에 작은 손자국이 하나둘 늘어난다....... 안쪽에서 두드리는 소리가 점점 커진다.',
    hp: 24,
    atk: 5,
    def: 1,
    coinReward: 16,
  ...
  },
  {
    ...
    category: '크리쳐',
    difficulty: 'hard',
    intro: '벽 한쪽이 숨 쉬듯 부풀었다 가라앉는다....... 벽 너머에서 손톱으로 긁는 소리가 멈추지 않는다.',
    hp: 66,
    atk: 14,
    def: 5,
    coinReward: 48,
