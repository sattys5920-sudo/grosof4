...
export const HALL_PUZZLES: HallPuzzle[] = [
  ...
  },
  {
    ...
    answer: 'HELPME',
    solution: '1번 자리 H, 2번 자리 E, 3번 자리 L, 4번 자리 P, 5번 자리 M, 6번 자리 E를 순서대로 이으면 HELPME.',
  },
  {
    id: 'hp07',
    title: '숫자 속 알파벳',
  ...
  },
  {
    ...
    title: '나무에 기대다',
    category: '한자',
    questionText: '사람(人)이 나무(木) 옆에 기대어 서 있는 모습을 본뜬 한자는 무엇인가? (한자 한 글자로 답하시오)',
    answer: '休',
    solution: '사람 인(人)과 나무 목(木)이 합쳐지면 쉴 휴(休)가 된다.',
  },
  {
    id: 'hp09',
    title: '250일 후',
    category: '요일',
    questionText: '오늘은 화요일이다. 250일 후는 무슨 요일인가?',
    answer: '일요일',
    solution: '250을 7로 나누면 몫 35, 나머지 5. 화요일에서 5일을 더하면 화→수→목→금→토→일, 즉 일요일.',
  },
  {
    id: 'hp10',
    title: '뜻으로 이어지는 사슬',
  ...
  },
  {
    ...
    answer: 'Kr',
    solution: '원자번호가 1, 4, 9, 16, 25로 각각 1², 2², 3², 4², 5²이다. 다음은 6²=36이며, 원자번호 36번 원소는 크립톤(Kr).',
  },
  {
    id: 'hp12',
    title: '좌표 속 암호',
    category: '암호',
    questionText:
      '가로 세로 각 5칸에 A~Z(I와 J는 한 칸)를 순서대로 채운 표가 있다.\n1행: A B C D E\n2행: F G H I/J K\n3행: L M N O P\n4행: Q R S T U\n5행: V W X Y Z\n좌표를 (행)(열) 순서의 두 자리 숫자로 나타낼 때, "44 42 11 35"가 뜻하는 단어는? (영문 대문자로 답하시오)',
    answer: 'TRAP',
    solution: '44=4행 4열=T, 42=4행 2열=R, 11=1행 1열=A, 35=3행 5열=P. 이어 붙이면 TRAP(함정).',
  },
  {
    id: 'hp13',
    title: '나에게 무언가를 더하면',
  ...
  },
  {
    ...
    category: '암호',
    questionText:
      '어떤 단어를 첫 글자는 1칸, 둘째 글자는 2칸, 셋째 글자는 3칸, 넷째 글자는 4칸, 다섯째 글자는 5칸씩 알파벳 순서로 뒤로 밀어 암호화했더니 "NQXWJ"가 되었다. 원래 단어는? (영문 대문자로 답하시오)',
    answer: 'MOUSE',
  ...
  },
  {
    ...
    category: '집합',
    questionText:
      '45명 학급에서 국어를 좋아하는 학생 22명, 수학 18명, 영어 20명이다. 국어·수학을 모두 좋아하는 학생 8명, 수학·영어 모두 7명, 국어·영어 모두 9명, 세 과목을 모두 좋아하는 학생은 4명이다. 세 과목 중 어느 것도 좋아하지 않는 학생은 몇 명인가?',
    answer: '5',
    solution: '적어도 한 과목을 좋아하는 학생 수 = 22+18+20-8-7-9+4=40. 전체 45명 중 나머지 45-40=5명은 어느 과목도 좋아하지 않는다.',
  },
  {
    id: 'hp17',
    title: '이름을 읽으면',
  ...
  },
  {
    ...
    answer: '127',
    solution: '각 항은 앞 항의 2배에 1을 더한 값이다. 63×2+1=127.',
  },
  {
    id: 'hp20',
    title: '한 명만 거짓말',
    ...
    answer: '을',
    solution:
      '범인이 을이라고 가정하면 갑의 말(범인은 나다)은 거짓, 을의 말(범인은 갑이 아니다)은 참, 병의 말(범인은 을이다)은 참 — 거짓말이 정확히 한 명이라는 조건과 맞는다. 다른 경우를 대입하면 거짓말한 사람이 0명이거나 2명이 되어 모순된다. 따라서 범인은 을.',
  },
  {
    id: 'hp21',
    title: '곱에서 합을 빼면',
  ...
  },
  {
    ...
    answer: '9',
    solution:
      '숫자를 겹쳐 쓸 때 생기는 교차점의 개수를 세는 규칙이다. 1(ONE)의 오른쪽 아래로 0(ZERO)을 겹쳐 쓰면 만들어지는 교차점이 6개가 된다. 같은 방식으로 ZERO와 ONE을 겹치면 교차점은 9개가 된다.',
  },
  {
    id: 'hp23',
    title: '색칠된 정육면체',
    category: '도형',
    questionText:
      '겉면을 모두 칠한 정육면체를 각 모서리를 3등분해 27개의 작은 정육면체로 잘랐다. 이 중 정확히 두 면만 칠해진 작은 정육면체는 몇 개인가?',
    answer: '12',
    solution: '모서리 위에 있지만 꼭짓점은 아닌 작은 정육면체가 두 면만 칠해진다. 정육면체는 모서리가 12개이고, 각 모서리마다 그런 조각이 정확히 1개씩 있으므로 총 12개.',
  },
  {
    id: 'hp24',
    title: '3도 5도 아닌 수',
    ...
    answer: '53',
    solution: '3의 배수는 33개, 5의 배수는 20개, 15의 배수(둘 다)는 6개이다. 3의 배수 또는 5의 배수는 33+20-6=47개이므로, 둘 다 아닌 수는 100-47=53개.',
  },
  {
    id: 'hp25',
    title: '세 수의 합',
  ...
  },
  {
    ...
    title: '16진수 해독',
    category: '숫자',
    questionText: '16진수 2F를 10진수로 바꾸면 얼마인가?',
    answer: '47',
  ...
  },
  {
    ...
    answer: 'At',
    solution: '원자번호가 1, 19, 39, 61, 85로 나열되며 앞뒤 차이가 18, 20, 22, 24로 2씩 커지는 규칙이다. 원자번호 85번 원소는 아스타틴(At).',
  },
  {
    id: 'hp30',
    title: '책상에 적힌 경고',
